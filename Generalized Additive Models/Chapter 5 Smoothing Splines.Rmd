...
under any rotations or reflections of covariates. Basically they are scale 
invariant, so putting the smooth values in different units won't change the 
smoothing effect of them; you'll get the same predictions if you use inches, 
feet, meters, etc...
